...
public class IssueBook extends javax.swing.JFrame {
    ...
    // Fetch the book details from the database and display them on the panel
   public void getBookDetails() {
       String isbn = txt_isbn.getText();

       try {
           java.sql.Connection con = DBConnection.getConnection();
           PreparedStatement pst = con.prepareStatement("SELECT * FROM book_details WHERE isbn = ?");
           ...
           if (rs.next()) {
               ...
               lbl_bookError.setText("Invalid ISBN");
           }
       } catch (Exception e) {
           e.printStackTrace();
       }
   ...
   // Fetch the student details from the database and display them on the panel
   ...
   public boolean issueBook() {
       ...
       try {
           java.sql.Connection con = DBConnection.getConnection();
           String sql = "INSERT INTO issue_book_details (isbn, book_name, student_id, student_name, issue_date, due_date, status) VALUES (?, ?, ?, ?, ?, ?, ?)";
   ...
   public boolean isAlreadyIssued() {
       ...
       try {
           java.sql.Connection con = DBConnection.getConnection();
           String sql = "SELECT * FROM issue_book_details WHERE isbn = ? AND student_id = ? AND status = ?";
           PreparedStatement pst = con.prepareStatement(sql);
           pst.setString(1, isbn);
    ...
    private void initComponents() {
        ...
        txt_isbn = new rojerusan.RSMetroTextPlaceHolder();
        ...
        panel_main.add(rSMaterialButtonCircle2, new org.netbeans.lib.awtextra.AbsoluteConstraints(1060, 530, 360, 60));
        ...
        jPanel1.add(lbl_quantity, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 490, 170, 30));
        ...
        lbl_isbn.setFont(new java.awt.Font("Yu Gothic UI", 1, 20)); // NOI18N
        lbl_isbn.setForeground(new java.awt.Color(255, 255, 255));
        jPanel1.add(lbl_isbn, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 260, 210, 30));
        ...
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 490, 110, 30));

        lbl_bookError.setFont(new java.awt.Font("Yu Gothic UI", 1, 20)); // NOI18N
        lbl_bookError.setForeground(new java.awt.Color(255, 255, 0));
        jPanel1.add(lbl_bookError, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 540, 270, 30));

        jLabel20.setFont(new java.awt.Font("Yu Gothic UI", 0, 20)); // NOI18N
        jLabel20.setForeground(new java.awt.Color(255, 255, 255));
        jLabel20.setText("Category:");
        jPanel1.add(jLabel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 440, 110, 30));

        lbl_category.setFont(new java.awt.Font("Yu Gothic UI", 1, 20)); // NOI18N
        lbl_category.setForeground(new java.awt.Color(255, 255, 255));
        jPanel1.add(lbl_category, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 440, 170, 30));

        panel_main.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 410, 870));
        ...
        panel_main.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 0, 450, 870));
        ...
        panel_main.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(1150, 90, 200, 120));
        ...
        panel_main.add(jPanel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(1060, 180, 350, 10));
        ...
        panel_main.add(jPanel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(1440, 0, 103, 42));

        jLabel9.setFont(new java.awt.Font("Roboto", 1, 17)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(204, 0, 0));
        jLabel9.setText("ISBN:");
        panel_main.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(1010, 230, 110, 30));

        jLabel10.setFont(new java.awt.Font("Roboto", 1, 17)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(204, 0, 0));
        jLabel10.setText("Issue Date :");
        panel_main.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(1010, 380, 100, 30));
        ...
        panel_main.add(date_issueDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(1170, 370, 270, 40));

        jLabel11.setFont(new java.awt.Font("Roboto", 1, 17)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(204, 0, 0));
        jLabel11.setText("Student ID :");
        panel_main.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(1010, 300, 110, 30));
        ...
        panel_main.add(date_dueDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(1170, 440, 270, 40));

        jLabel19.setFont(new java.awt.Font("Roboto", 1, 17)); // NOI18N
        jLabel19.setForeground(new java.awt.Color(204, 0, 0));
        jLabel19.setText("Due Date :");
        panel_main.add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(1010, 450, 100, 30));

        txt_studentId.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 2, 0, new java.awt.Color(153, 0, 0)));
        txt_studentId.setForeground(new java.awt.Color(153, 153, 153));
        txt_studentId.setFont(new java.awt.Font("Segoe UI", 0, 17)); // NOI18N
        txt_studentId.setPhColor(new java.awt.Color(153, 153, 153));
        ...
        panel_main.add(txt_studentId, new org.netbeans.lib.awtextra.AbsoluteConstraints(1170, 290, -1, 50));

        txt_isbn.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 2, 0, new java.awt.Color(153, 0, 0)));
        txt_isbn.setForeground(new java.awt.Color(153, 153, 153));
        txt_isbn.setFont(new java.awt.Font("Segoe UI", 0, 17)); // NOI18N
        txt_isbn.setPhColor(new java.awt.Color(153, 153, 153));
        ...
        panel_main.add(txt_isbn, new org.netbeans.lib.awtextra.AbsoluteConstraints(1170, 230, -1, 50));

        getContentPane().add(panel_main, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1580, 870));

        setSize(new java.awt.Dimension(1538, 882));
    ...
    private rojerusan.RSMetroTextPlaceHolder txt_isbn;
